    ...
    <div class="row display-flex header-flex">
      <div class="col-md-2 margin-auto trigger-menu">
        ...
        <button type="button" class="navbar-toggle collapsed visible-xs" id="trigger-mobile">
          <span class="sr-only">Thanh công cụ</span>
  ...
  <div class="mobile-main-menu-bottom">
    <div class="mobile-support">
      ...
      <div class="info-support">
        <i class="fa fa-phone" aria-hidden="true"></i> HOTLINE: <a href="tel: 0979396926" title="0979396926">0326663040</a>
      </div>
      <div class="info-support">
        <i class="fa fa-envelope" aria-hidden="true"></i> EMAIL: <a href="mailto:chautattoo1995@gmail.com" title="chautattoo1995@gmail.com">dinhtuong@gmail.com</a>
      </div>
    </div>
  </div>
</div>
